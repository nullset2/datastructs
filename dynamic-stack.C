/*Basado en mi trabajo anterior de listas dinámicas, implementaré una pila con asignación dinámica de memoria
José Alfredo Gallegos C., Abril 2011*/

/*pila: estructura LIFO... Last-In, First-Out, esa es la clave para hacer fácil la implementación... solo tendré que tweakear un poco mis módulos!*/
...
//La única diferencia comparado al de la lista: no toma un data para buscar el nodo que lo tiene y eliminarlo, sino que solo elimina el final!
void deleteNode(){
     ...
     if(seek == head){                                                          //caso especial si va a borrar el inicio de la pila, es decir, no recorrió en el while
          head = NULL;                                                          //hace que head apunte al nodo después del primero
          printf("\nEliminado: %d...\n", seek->data);                           //muestra confirmación
     ...
     printf("\nEliminado: %d...\n", seek->data);                                //muestra mensaje de confirmación
...
void printList()
{
     ...
     if(head == NULL){                                                          //caso especial en que no hay nodos en la pila todavía
